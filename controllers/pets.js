...
module.exports.run_setup = function(app) {
    ...
    app.get('/home', (req, res) => {
        res.render('partials/template', {name : 'Home', content : fs.readFileSync(__dirname + '/../views/index.hbs')});
    });

    app.get('/mylabs', (req, res) => {
        res.render('partials/template', {name : 'Labs', content : fs.readFileSync(__dirname + '/../views/labs.hbs')});
    });

    app.get('/fun', (req, res) => {
        res.render('partials/template', {name : 'Fun', content : fs.readFileSync(__dirname + '/../views/fun.hbs')});
    });

    app.get('/pets', (req, res) => {
        res.render('partials/template', {name : 'Pets', content : fs.readFileSync(__dirname + '/../views/pets.hbs')});
    });
